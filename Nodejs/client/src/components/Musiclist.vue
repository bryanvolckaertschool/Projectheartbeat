<template>
	...
	<v-card elevation="5" class="pa-1" style="overflow: hidden;">
		<v-card-title>{{Naam}}
		</v-card-title>
		<v-container fluid class="pa-0 ma-0">
			...
			<v-row class="pa-2 ma-0">
				...
				<v-col md1 lg="1" class="pa-0 ma-5 mx-0 text-right">
					<!-- hier udpate compo -->
	...
	<v-row justify="space-around">
		<addsong :User="User"/>
		<v-btn  small fab dark color="blue lighten-1" class="ma-5" @click="getsongs">
